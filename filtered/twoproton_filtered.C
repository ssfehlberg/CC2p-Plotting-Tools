#define twoproton_filtered_cxx
#include "twoproton_filtered.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <fstream>

void twoproton_filtered::Loop()
{

  //Making a new Root File that will contain all the histograms that we will want to plot:
  ///////////////////////////////////////////////////////////////////////////////////////
  TFile *tfile = new TFile("histograms_filtered.root","RECREATE");
  ...
  myfile.open("files_filtered.list");
  cc2p.open("files_filtered_cc2p.list");
  ccNp0pi_file.open("files_filtered_ccNp0pi.list"); 
