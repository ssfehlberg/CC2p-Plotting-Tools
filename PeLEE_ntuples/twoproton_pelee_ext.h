...
// Wed Nov 18 15:08:40 2020 by ROOT version 6.12/06
// from TTree NeutrinoSelectionFilter/Neutrino Selection TTree
// found on file: /uboone/data/users/davidc/searchingfornues/v08_00_00_43/0702/run1/data_extbnb_mcc9.1_v08_00_00_25_reco2_C_all_reco2.root
//////////////////////////////////////////////////////////

#ifndef twoproton_pelee_ext_h
#define twoproton_pelee_ext_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   twoproton_pelee_ext(TTree *tree=0);
   virtual ~twoproton_pelee_ext();
...
Int_t twoproton_pelee_ext::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t twoproton_pelee_ext::LoadTree(Long64_t entry)
{
...
void twoproton_pelee_ext::Init(TTree *tree)
{
...
Bool_t twoproton_pelee_ext::Notify()
{
...
void twoproton_pelee_ext::Show(Long64_t entry)
{
...
Int_t twoproton_pelee_ext::Cut(Long64_t entry)
{
...
#endif // #ifdef twoproton_pelee_ext_cxx
