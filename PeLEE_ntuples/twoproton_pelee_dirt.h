...
// Wed Nov 18 15:10:01 2020 by ROOT version 6.12/06
// from TTree NeutrinoSelectionFilter/Neutrino Selection TTree
// found on file: /pnfs/uboone/persistent/users/davidc/searchingfornues/v08_00_00_43/0928/prodgenie_bnb_dirt_overlay_mcc9.1_v08_00_00_26_run1_reco2_reco2.root
//////////////////////////////////////////////////////////

#ifndef twoproton_pelee_dirt_h
#define twoproton_pelee_dirt_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   twoproton_pelee_dirt(TTree *tree=0);
   virtual ~twoproton_pelee_dirt();
...
#ifdef twoproton_pelee_dirt_cxx
twoproton_pelee_dirt::twoproton_pelee_dirt(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/uboone/persistent/users/davidc/searchingfornues/v08_00_00_43/0928/prodgenie_bnb_dirt_overlay_mcc9.1_v08_00_00_26_run1_reco2_reco2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/uboone/persistent/users/davidc/searchingfornues/v08_00_00_43/0928/prodgenie_bnb_dirt_overlay_mcc9.1_v08_00_00_26_run1_reco2_reco2.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/pnfs/uboone/persistent/users/davidc/searchingfornues/v08_00_00_43/0928/prodgenie_bnb_dirt_overlay_mcc9.1_v08_00_00_26_run1_reco2_reco2.root:/nuselection");
...
twoproton_pelee_dirt::~twoproton_pelee_dirt()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t twoproton_pelee_dirt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t twoproton_pelee_dirt::LoadTree(Long64_t entry)
{
...
void twoproton_pelee_dirt::Init(TTree *tree)
{
...
Bool_t twoproton_pelee_dirt::Notify()
{
...
void twoproton_pelee_dirt::Show(Long64_t entry)
{
...
Int_t twoproton_pelee_dirt::Cut(Long64_t entry)
{
...
#endif // #ifdef twoproton_pelee_dirt_cxx
