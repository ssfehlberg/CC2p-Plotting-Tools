#define twoproton_unfiltered_dirt_cxx
#include "twoproton_unfiltered_dirt.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void twoproton_unfiltered_dirt::Loop()
{
  //Making a new Root File that will contain all the histograms that we will want to plot:                                                                ///////////////////////////////////////////////////////////////////////////////////////                                                              
  TFile *tfile = new TFile("histograms_unfiltered_dirt.root","RECREATE");

  //File with RSE's in them                                                                                                                           
  ofstream myfile;//File that will contain RSE of good events                                                                                          
  myfile.open("files_unfiltered_dirt.list");
  ...
  float_t zmax = 1036.8 - FV_edge;
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //Okay Ndirt: We need to require things to be from the neutrino slice cause otherwise this is going to be a hot mess                              
