...
void twoproton_unfiltered_bnb::Loop()
{
  ...
  float_t zmax = 1036.8 - FV_edge;
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //Okay Nbnb: We need to require things to be from the neutrino slice cause otherwise this is going to be a hot mess                              
	...
	if(chi2p_3D->at(value) < 50){ //this is our PID cut. Indicates track is a proton 70
	  ...
	  muon_vector.push_back(value); //id of the other trac70k
	}else{
