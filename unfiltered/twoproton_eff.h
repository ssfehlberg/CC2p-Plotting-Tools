...
// from TTree tree/
// found on file: /pnfs/uboone/scratch/users/sfehlber/2020/April/Apr16/CC2p/overlay_analyzer/final.root
//////////////////////////////////////////////////////////
...
void twoproton_eff::Check_Containment(float FV_edge, int shortest_trk_index, int longest_trk_index, vector<float> good_trk, vector<float> good_trk_start_x, vector<float> good_trk_start_y, vector<float> good_trk_start_z, vector<float> good_trk_end_x, vector<float> good_trk_end_y, vector<float> good_trk_end_z){
