...
void analysis::main(){
  ...
  TFile *f_mom_thresholds =new TFile(Form("root_files/pelee/%s/efficiency.root",run)); //All efficiency histograms
  ...
  */
  ...
  for(int i = 0; i< num_cuts; i++){
	...
	h_overlay_raquel_vec.push_back(h_overlay_raquel[i][j][k]);
       ...
       Plot_Histograms(run,pot_num,sample_name,colors, h_overlay_vec, h_overlay0[i][j][0],h_overlay0[i][j][1],h_overlay0[i][j][2], h_ext[i][j][0], h_ext[i][j][1], h_ext[i][j][2], h_dirt[i][j][0],h_dirt[i][j][1],h_dirt[i][j][2],h_bnb[i][j][0],h_bnb[i][j][1],canv[i][j], h[i][j], pad[i][j], pad0[i][j], legend[i][j], channel_legend, ylim[run_num][i][j],ymin[run_num][i][j], num_channels, titles[j], path, a1 ,"", plots[j], cut[i], false, true, false, 0.0, 0.19, 0.5, 1.5,  xmin_vtx[j], xmax_vtx[j]);
      h_overlay_vec.clear();
      
      Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_overlay_raquel_vec, h_overlay0_raquel[i][j][0],h_overlay0_raquel[i][j][1],h_overlay0_raquel[i][j][2], h_ext[i][j][0], h_ext[i][j][1], h_ext[i][j][2], h_dirt[i][j][0],h_dirt[i][j][1],h_dirt[i][j][2],h_bnb[i][j][0],h_bnb[i][j][1],canv_raquel[i][j], h_raquel[i][j], pad_raquel[i][j], pad0_raquel[i][j], legend_raquel[i][j], channel_legend_raquel, ylim[run_num][i][j],ymin[run_num][i][j], num_channels_raquel, titles[j], path,   a1,"", plots[j], Form("%s_raquel",cut[i]), false, true, false, 0.0, 0.19, 0.5, 1.5, xmin_vtx[j], xmax_vtx[j]);
  ...
  for(int i = 0; i < num_var; i++){
    ...
    //muon:mine
    Plot_Histograms(run,pot_num,sample_name,colors, h_muon_overlay_vec, h_muon_overlay0[i][0],h_muon_overlay0[i][1],h_muon_overlay0[i][2],
    ...
    //muon:raquel
     Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_muon_overlay_raquel_vec, h_muon_overlay0_raquel[i][0],h_muon_overlay0_raquel[i][1],h_muon_overlay0_raquel[i][2],
		    h_muon_ext[i][0], h_muon_ext[i][1], h_muon_ext[i][2],
		    h_muon_dirt[i][0],h_muon_dirt[i][1],h_muon_dirt[i][2],
    ...
    //recoil proton:mine
    Plot_Histograms(run,pot_num,sample_name,colors, h_recoil_overlay_vec, h_recoil_overlay0[i][0],h_recoil_overlay0[i][1],h_recoil_overlay0[i][2],
    ...
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_recoil_overlay_raquel_vec, h_recoil_overlay0_raquel[i][0],h_recoil_overlay0_raquel[i][1],h_recoil_overlay0_raquel[i][2],
		    h_recoil_ext[i][0], h_recoil_ext[i][1], h_recoil_ext[i][2],
		    h_recoil_dirt[i][0],h_recoil_dirt[i][1],h_recoil_dirt[i][2],
    ...
    //leading proton:mine
    Plot_Histograms(run,pot_num,sample_name,colors, h_leading_overlay_vec, h_leading_overlay0[i][0],h_leading_overlay0[i][1],h_leading_overlay0[i][2],
    ...
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_leading_overlay_raquel_vec, h_leading_overlay0_raquel[i][0],h_leading_overlay0_raquel[i][1],h_leading_overlay0_raquel[i][2],
		    h_leading_ext[i][0], h_leading_ext[i][1], h_leading_ext[i][2],
		    h_leading_dirt[i][0],h_leading_dirt[i][1],h_leading_dirt[i][2],
  ...
  for(int i=0; i < num_phys; i++){
    ...
    //mine 
    Plot_Histograms(run,pot_num,sample_name,colors, h_phys_overlay_vec, h_phys_overlay0[i][0],h_phys_overlay0[i][1],h_phys_overlay0[i][2],
    ...
    //raquel
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_phys_overlay_raquel_vec, h_phys_overlay0_raquel[i][0],h_phys_overlay0_raquel[i][1],h_phys_overlay0_raquel[i][2],
		    h_phys_ext[i][0], h_phys_ext[i][1], h_phys_ext[i][2],
                    h_phys_dirt[i][0],h_phys_dirt[i][1],h_phys_dirt[i][2],
  ...
  for(int i=0; i < num_stv; i++){
    ...
    //mine 
    Plot_Histograms(run,pot_num,sample_name,colors, h_stv_overlay_vec, h_stv_overlay0[i][0],h_stv_overlay0[i][1],h_stv_overlay0[i][2],
    ...
    //raquel
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_stv_overlay_raquel_vec, h_stv_overlay0_raquel[i][0],h_stv_overlay0_raquel[i][1],h_stv_overlay0_raquel[i][2],
                    h_stv_ext[i][0], h_stv_ext[i][1], h_stv_ext[i][2],
                    h_stv_dirt[i][0],h_stv_dirt[i][1],h_stv_dirt[i][2],
